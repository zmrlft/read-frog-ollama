...
function createLucideIcon(iconName: string, iconNode: IconNode) {
  const Component = (
    { ref, className, size = 24, color = 'currentColor', children, ...props }: LucideProps & { ref?: React.RefObject<SVGSVGElement | null> },
  ) => {
    return (
      <svg
        ref={ref}
